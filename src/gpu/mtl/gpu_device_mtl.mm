...
std::unique_ptr<GPUBuffer> GPUDeviceMTL::CreateBuffer(const GPUBufferDescriptor& desc) {
  return std::make_unique<GPUBufferMTL>(desc, mtl_device_, mtl_command_queue_);
}
