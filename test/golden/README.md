...
To create missing golden images, opt in explicitly through the runner:

```bash
SKITY_UPDATE_MISSING_GOLDEN=1 python3 tools/test-runner.py --suite=golden-shape --filter=<test_case_name>
```
